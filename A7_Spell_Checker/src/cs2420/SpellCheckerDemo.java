 ...
 * 
 * @author germain, Tony Diep, Gabbie Hoyer
 */
public class SpellCheckerDemo 
{
  public static void main(String[] args) 
  {
    SpellChecker mySC = new SpellChecker(new File("Resources/dictionary.txt"));

    run_spell_check(mySC, "Resources/hello_world.txt");
    run_spell_check(mySC, "Resources/good_luck.txt");
  }
